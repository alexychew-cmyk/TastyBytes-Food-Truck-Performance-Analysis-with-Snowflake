-- =========================================
-- Project: Raw Zone and Harmonized Views Load
-- Description:
-- This script sets up Snowflake tables for the Raw Zone (POS and Customer data),
-- loads S3 data into stages, builds Iceberg tables and views, 
-- and creates harmonized and analytics views for reporting and analysis.
-- =========================================
...
-- =========================================
-- 2️⃣ Create External Stage on S3
-- Description:
-- Sets up a stage pointing to AWS S3 bucket 'sfquickstarts/frostbyte_tastybytes'.
-- File format is CSV.
-- =========================================
...
-- =========================================
-- 3️⃣ Raw Zone Table Creation
-- Description:
-- Creates base tables for POS (country, franchise, location, menu, truck, orders) 
...
-- =========================================
-- 4️⃣ Harmonized View Creation
-- Description:
-- Joins raw tables to create harmonized views for order details and customer loyalty metrics.
-- =========================================
-- Orders view
...
CREATE OR REPLACE VIEW frostbyte_tasty_bytes.harmonized.customer_loyalty_metrics_v AS
SELECT 
    cl.customer_id,
    cl.city,
    cl.country,
...
-- =========================================
-- 5️⃣ Analytics View Creation
-- Description:
-- Builds analytics-ready views from harmonized data for reporting and analysis.
-- =========================================
...
AS
SELECT * 
FROM frostbyte_tasty_bytes.harmonized.customer_loyalty_metrics_v;
